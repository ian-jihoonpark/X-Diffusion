...
from models.resenet_blocks import ResnetBlock2D, Downsample2D, Upsample2D, ResnetDownsampleBlock2D, ResnetUpsampleBlock2D
from models.attentions import (
    DualTransformer2DModel, Transformer2DModel, CrossAttention, 
    ...
    AttnDownEncoderBlock2D, DownEncoderBlock2D, SkipDownBlock2D, AttnSkipDownBlock2D
    )
...
class CrossAttnDownBlock2D(nn.Module):
    def __init__(
        ...
        self.has_cross_attention = True
        self.attn_num_head_channels = attn_num_head_channels #8
