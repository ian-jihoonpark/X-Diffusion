...
from models.resenet_blocks import ResnetBlock2D, Downsample2D, Upsample2D, FirUpsample2D, FirDownsample2D
...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # in_channels // attn_num_head_channels(8)
...
class CrossAttention(nn.Module):
    ...
    def save_key(self, hidden):
        self.key_state = hidden

    def get_key(self):
        return self.key_state

    def save_value(self, hidden):
        self.value_state = hidden

    def get_value(self):
        return self.value_state

    def save_cnd_hidden(self, hidden):
        self.cnd_state = hidden

    def get_cnd_hidden(self):
        return self.cnd_state
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None):
        ...
        self.save_cnd_hidden(encoder_hidden_states)
...
# None
    ...
    def _attention(self, query, key, value, attention_mask=None):
        ...
        # reshape hidden_states
        hidden_states = self.reshape_batch_dim_to_heads(hidden_states)
        self.save_attn(attention_probs.requires_grad_(True))
